      ...
      <div className={`mobile-drawer ${mobileOpen ? 'open' : ''}`}>
        ...
        <div className="mobile-drawer-body">
          <nav className="mobile-drawer-links">
            ...
            <a href="#regional" onClick={closeMobile} className="mobile-drawer-link">
              <span className="link-num">03</span>
              <span className="link-text">Vision Régionale</span>
              <ArrowUpRight size={18} className="link-arrow" />
            </a>
            <a href="#impact" onClick={closeMobile} className="mobile-drawer-link">
              <span className="link-num">04</span>
              <span className="link-text">Bilan d'Impact</span>
              <ArrowUpRight size={18} className="link-arrow" />
            </a>
          </nav>
        </div>
